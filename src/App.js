...
function App() {
  ...
  return (
    ...
    <Navbar projectsRef={projectsRef} homeRef={homeRef} infoRef={infoRef} skillRef={skillRef} contactRef={contactRef} workRef={workRef} />
    <div className="item-container"  ref={homeRef}><Home /></div> 
    <div className="item-container"  ref={infoRef}><About /></div> 
    <div className="item-container"  ref={workRef}><Work /></div> 
