...
const Skills = () => {
  ...
  return (
    <Box w="100%" >
      <Box>
        <Text fontWeight={"bold"} fontSize="23px" mb="30px">Skills</Text>
      </Box>
...
{/* front end */}
<Box>
  <Box><Text fontSize="20px" fontWeight="bold" mb="30px" mt="20px">Frontend</Text></Box>
<SimpleGrid
      columns={[2, 3, 4]}
      gap="20px"
      w={{ base: "80%", sm: "80%", md: "80%" }}
    ...
    <Box>
      <Box><Text fontSize="20px" fontWeight="bold" mb="30px" mt="20px">Backend</Text></Box>
      <SimpleGrid columns={[2, 3, 4]} 
        ...
        >
          <Image
            ...
            w="100%"
            m="auto"
            src="https://i.imgur.com/vQ6quTK.png"
            alt="not-found"
          />
        </Box>
...
{/* DSA */}
    ...
    <Box>
      <Box><Text fontSize="20px" fontWeight="bold" mb="30px" mt="20px">Data Structures & Algorithm</Text></Box>
    ...
    {/* <Statistics/> */}
    <Text fontWeight="bold" mt="30px" fontSize={{base:"18px",sm:"20px",md:"22px",lg:"24px"}}  textAlign="center" >
        Statistics
      </Text>
      ...
      <Box w="80%" m="auto">
        ...
        <Box w="65%" m="auto"><Image m="auto"mt={{lg:"120px"}} w="100%" height={{base:"100px",sm:"140px"}} align="center" src="https://github-readme-stats.vercel.app/api?username=Bhavesh2302&show_icons=true&include_all_commits=true&count_private=true&hide=issues,contribs&border_radius=0&locale=en" alt="Bhavesh2302"  /></Box>
      
    <Box width="80%" m="auto" mt={{base:"0px",sm:"0px",md:"20px",lg:"20px"}}>  <GitHubCalendar username="bhavesh2302" style={{width:"100%",margin:"auto"}}    /></Box>
